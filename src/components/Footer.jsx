      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-[#009DA5] transition-colors">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2024 Asian Unicorn. Tất cả quyền được bảo lưu.
          </div>
          <div className="flex items-center space-x-4">
            <span className="text-gray-400 text-sm">Asian Unicorn, 01 Nguyễn Văn A, Quận 1, TP.HCM</span>
            <div className="flex items-center space-x-2">
              <span className="text-gray-400 text-sm">📞</span>
              <span className="text-gray-400 text-sm">(028) 456-7890</span>
            </div>
          </div>
        </div>
      </div>
