  ...
  return (
    <div
      ...
      <div className="absolute inset-0 pointer-events-none z-10" style={inheritRadius}>
        <div
          ref={strokeRef}
          className="absolute inset-0 box-border z-20"
          style={strokeStyle} />
        <div className="absolute inset-0 box-border z-15" style={glow1Style} />
        <div className="absolute inset-0 box-border z-10" style={glow2Style} />
        <div className="absolute inset-0 z-5" style={bgGlowStyle} />
      </div>
