    ...
    <a
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/2 p-2 top-1/2 flex justify-start items-start rounded-xl shadow-[0_1px_2px_rgb(0_0_0/0.2)] bg-black border border-white/10 group-hover/pin:border group-hover/pin:border-white/20 transition duration-700 overflow-hidden">
